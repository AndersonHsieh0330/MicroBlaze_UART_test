...
HD_PWD='C:/Users/andy1/fpgaProjects/UART_to_PC/UART_to_PC.runs/design_1_reset_inv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_reset_inv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_reset_inv_0_0.tcl
